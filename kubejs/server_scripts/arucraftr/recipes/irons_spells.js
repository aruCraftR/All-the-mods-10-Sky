ServerEvents.recipes((allthemods) => {
  ...
  allthemods
    .custom({
      ...
      reagent: [Ingredient.of("irons_spellbooks:diamond_spell_book").toJson()],
      result: {
        count: 1,
  ...
  allthemods
    .custom({
      ...
      reagent: [Ingredient.of("minecraft:stone").toJson()],
      result: {
        count: 1,
  ...
  allthemods
    .custom({
      ...
      reagent: [Ingredient.of("chipped:reinforced_netherite_block").toJson()],
      result: {
        count: 1,
